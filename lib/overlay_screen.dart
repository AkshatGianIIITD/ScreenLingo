                  ...
                  children: [
                    ...
                    ...textData.map((data) {
                      ...
                      Rect boundingBox = Rect.fromLTWH(
                        data["boundingBox"]["left"].toDouble() /
                            devicePixelRatio,
                        data["boundingBox"]["top"].toDouble() /
                            devicePixelRatio,
                      ...
                      int bgColorValue = data["backgroundColor"] | 0xFF000000;
                      return Positioned(
                        ...
                        child: Container(
                          ...
                          child: AutoSizeText(
                            ...
                            maxLines: data[
                                "numLines"], // Let it to the same number of lines as the original text.
